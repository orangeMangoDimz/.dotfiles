...
- Locate context directories (`/home/orangemango/.config/opencode/context/`, `docs/`, `.context/`, etc.)
...
```
/home/orangemango/.config/opencode/context/
...
```bash
list(path="/home/orangemango/.config/opencode/context")
```
...
list(path="/home/orangemango/.config/opencode/context/{category}")

# Read relevant files
read(filePath="/home/orangemango/.config/opencode/context/{category}/{file}.md")
```
...
**Context Location**: `/home/orangemango/.config/opencode/context/`
**Files Searched**: 12
...
#### ⭐⭐⭐⭐⭐ Code Standards
**Path**: `/home/orangemango/.config/opencode/context/core/standards/code.md`
...
/home/orangemango/.config/opencode/context/core/workflows/
└── review.md ⭐ FOUND
```
...
3. `/home/orangemango/.config/opencode/context/core/workflows/review.md` - Code review expectations
...
### Additional Context Available
If you need more information on:
- **Code standards** → Check `/home/orangemango/.config/opencode/context/core/standards/code.md`
- **Testing guidelines** → Check `/home/orangemango/.config/opencode/context/core/standards/tests.md`
```

## Discovery Patterns

### Pattern 1: Well-Organized Context
Repository has clear context structure (`/home/orangemango/.config/opencode/context/` or `docs/`)
