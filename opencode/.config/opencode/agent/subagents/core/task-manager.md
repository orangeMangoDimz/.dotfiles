...
BEFORE starting task breakdown, ALWAYS:
  1. Load context: `/home/orangemango/.config/opencode/context/core/task-management/navigation.md`
...
- Tasks without status check → Duplicate work, conflicts
  ...
  <interaction_protocol>
    <with_meta_agent>
      ...
      - Do NOT read `/home/orangemango/.config/opencode/context/core/workflows/task-delegation-basics.md` or follow delegation workflows.
    ...
    <stage id="0" name="ContextLoading">
      ...
      <process>
        1. Load task management context:
           - `/home/orangemango/.config/opencode/context/core/task-management/navigation.md`
           - `/home/orangemango/.config/opencode/context/core/task-management/standards/task-schema.md`
           - `/home/orangemango/.config/opencode/context/core/task-management/guides/splitting-tasks.md`
           - `/home/orangemango/.config/opencode/context/core/task-management/guides/managing-tasks.md`
         ...
         3. Create subtask_NN.json for each task:
             ...
             **AGENT FIELD SEMANTICS**:
              ...
              **FRONTEND RULE**: If a task involves UI design, styling, or frontend implementation:
              ...
              2. Include `/home/orangemango/.config/opencode/context/ui/web/ui-styling-standards.md` and `/home/orangemango/.config/opencode/context/core/workflows/design-iteration-overview.md` in `context_files`.
