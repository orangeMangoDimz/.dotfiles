...
**The AOC solution:** Store team patterns in `/home/orangemango/.config/opencode/context/project/`. Commit to repo. Everyone uses same standards.
...
# Commit to repo
git add /home/orangemango/.config/opencode/context/
...
Store patterns in `/home/orangemango/.config/opencode/context/project/`. Commit to repo. Entire team uses same standards. New developers inherit patterns automatically.
...
```
1. Check local: /home/orangemango/.config/opencode/context/core/navigation.md
...
- **Project intelligence is always local** — your tech stack, patterns, and naming conventions live in `/home/orangemango/.config/opencode/context/project-intelligence/` and are never loaded from global
...
|-------|----------------|--------------------------|
| Local install (`bash install.sh developer`) | `/home/orangemango/.config/opencode/context/core/` | `/home/orangemango/.config/opencode/context/project-intelligence/` |
| Global install + `/add-context` | `~/.config/opencode/context/core/` | `/home/orangemango/.config/opencode/context/project-intelligence/` |
| Both local and global | `/home/orangemango/.config/opencode/context/core/` (local wins) | `/home/orangemango/.config/opencode/context/project-intelligence/` |
...
A: Commit `/home/orangemango/.config/opencode/context/project/` to your repo. Team members automatically use same patterns.
