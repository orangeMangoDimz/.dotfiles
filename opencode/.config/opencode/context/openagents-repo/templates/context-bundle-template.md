...
**Core Standards**:
- `/home/orangemango/.config/opencode/context/core/standards/code.md` → Modular, functional code patterns
- `/home/orangemango/.config/opencode/context/core/standards/tests.md` → Testing requirements and TDD
- `/home/orangemango/.config/opencode/context/core/standards/docs.md` → Documentation standards
- `/home/orangemango/.config/opencode/context/core/standards/patterns.md` → Error handling, security patterns

**Core Workflows**:
- `/home/orangemango/.config/opencode/context/core/workflows/delegation.md` → Delegation process
- `/home/orangemango/.config/opencode/context/core/workflows/task-breakdown.md` → Task breakdown methodology
- `/home/orangemango/.config/opencode/context/core/workflows/review.md` → Code review guidelines
