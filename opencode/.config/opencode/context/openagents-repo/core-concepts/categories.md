...
/home/orangemango/.config/opencode/context/development/
├── navigation.md
├── clean-code.md
├── react-patterns.md
└── api-design.md
...
mkdir -p /home/orangemango/.config/opencode/context/{category}
...
```bash
cat > /home/orangemango/.config/opencode/context/{category}/navigation.md << 'EOF'
...
```
/home/orangemango/.config/opencode/context/{category}/
...
Loads: `/home/orangemango/.config/opencode/context/development/react-patterns.md`
