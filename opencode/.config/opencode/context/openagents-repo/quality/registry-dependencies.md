...
- Code tasks → /home/orangemango/.config/opencode/context/core/standards/code-quality.md (MANDATORY)
```
...
**Path normalization**:
```
File path:     /home/orangemango/.config/opencode/context/core/standards/code-quality.md
...
```
dependencies:
  - context:core/standards/code           # /home/orangemango/.config/opencode/context/core/standards/code-quality.md
  - context:core/standards/docs           # /home/orangemango/.config/opencode/context/core/standards/documentation.md
  - context:core/workflows/delegation     # /home/orangemango/.config/opencode/context/core/workflows/task-delegation-basics.md
...
- context:core/standards/code (referenced 3 times)
  - Line 64: "Code tasks → /home/orangemango/.config/opencode/context/core/standards/code-quality.md"
...
```bash
# Make your changes
vim /home/orangemango/.config/opencode/context/core/standards/code-quality.md
```
...
ls -la /home/orangemango/.config/opencode/context/core/standards/code-quality.md
...
rm /home/orangemango/.config/opencode/context/core/standards/code-analysis.md
./scripts/registry/auto-detect-components.sh --auto-add
```
...
- **Registry Guide**: `/home/orangemango/.config/opencode/context/openagents-repo/guides/updating-registry.md`
- **Registry Concepts**: `/home/orangemango/.config/opencode/context/openagents-repo/core-concepts/registry.md`
- **Adding Agents**: `/home/orangemango/.config/opencode/context/openagents-repo/guides/adding-agent.md`
