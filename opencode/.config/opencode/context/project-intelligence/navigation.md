...
```
/home/orangemango/.config/opencode/context/project-intelligence/
...
- `/home/orangemango/.config/opencode/context/core/standards/project-intelligence.md` (standards and patterns)
- `/home/orangemango/.config/opencode/context/core/system/context-guide.md` (context loading)

See `/home/orangemango/.config/opencode/context/core/context-system.md` for the broader context architecture.
...
**Management Guide**: See `/home/orangemango/.config/opencode/context/core/standards/project-intelligence-management.md` for complete lifecycle management including:
...
See `/home/orangemango/.config/opencode/context/core/standards/project-intelligence.md` for the standard itself.
