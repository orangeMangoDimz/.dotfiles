...
**Rule**: If it's not in `/home/orangemango/.config/opencode/context/`, use ExternalScout.
...
| **Location** | `/home/orangemango/.config/opencode/context/` | Internet (Context7, docs) |
