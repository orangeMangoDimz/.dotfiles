...
- Answer is in `/home/orangemango/.config/opencode/context/` (use ContextScout instead)
...
- **External Context Management**: `/home/orangemango/.config/opencode/context/core/workflows/external-context-management.md`
- **Task Delegation**: `/home/orangemango/.config/opencode/context/core/workflows/task-delegation-basics.md`
