...
**Index Location**: `/home/orangemango/.config/opencode/context/navigation.md` - Quick map of all contexts
...
**Central Index**: `/home/orangemango/.config/opencode/context/navigation.md` - Ultra-compact map of all contexts
...
All files are in `/home/orangemango/.config/opencode/context/core/` with organized subfolders:
...
- Load `/home/orangemango/.config/opencode/context/navigation.md`
...
### /home/orangemango/.config/opencode/context/core/standards/security-patterns.md
- Error handling
- Security patterns
- Common code patterns

### /home/orangemango/.config/opencode/context/core/standards/code-analysis.md
- Analyzing codebase patterns
- Investigating bugs
- Evaluating architecture

### /home/orangemango/.config/opencode/context/core/workflows/task-delegation-basics.md
- Delegating to general agent
- Creating task context
- Multi-file coordination

### /home/orangemango/.config/opencode/context/core/workflows/feature-breakdown.md
- Tasks with 4+ files
- Estimated effort >60 minutes
- Complex dependencies

### /home/orangemango/.config/opencode/context/core/workflows/session-management.md
- Session lifecycle
- Cleanup procedures
- Session isolation
